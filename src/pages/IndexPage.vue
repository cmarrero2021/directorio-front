<template>
  ...
  <div class="q-ml-md q-mr-md sections-wrapper">
    ...
    <div v-else class="row items-stretch no-wrap">
      ...
      <div
        class="col-md-6 q-px-sm section-container"
        :ref="
          (el) => {
            if (el) sectionRefs[0] = el;
          }
        "
      >
        <div class="content-wrapper text-left">
          <p style="font-family: Gotham Bold; font-size: 36px">
            {{ secciones[0].titulo }}
          </p>
  ...
  <div
    ...
    style="margin-top: 20px; gap: 60px"
  >
    <div
  ...
  <div class="q-pa-xl footer-sections">
    <div class="row q-col-gutter-xs center-around footer-container">
      ...
      <div class="column footer-column">
        <div class="text-h6 q-mb-sm" style="font-family: Gotham Bold">
          Enlaces
        </div>
        <div
          class="text-h7 text-white"
          title="Observatorio Nacional de Ciencia, Tecnología e Innovación"
        >
      ...
      <div class="column footer-column">
        ...
        >
          <div class="col-3">
            <q-img :src="portada1" width="50px" height="60px" />
          </div>
        ...
        <div
          class="row q-pa-sm"
          style="border: 1px solid white; border-radius: 8px"
        >
          <div class="col-3">
            <q-img :src="portada2" width="50px" height="60px" />
          </div>
      ...
      <div class="column footer-column">
        ...
        <div class="row items-start q-mb-sm">
          ...
          <div class="text-body2">
            Avenida Universidad, esquina El Chorro, <br />Torre Ministerial,
            piso 16, La Hoyada, <br />
...
const enviar = async () => {
  ...
  try {
    ...
    Notify.create({
      message:
        response.data.length > 0 ? response.data : "Correo ya registrado",
